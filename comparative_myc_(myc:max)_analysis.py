...
CONDITIONS = {
    "MYC alone": {
        "replicas": [
            {"psf": "MYC/MYC-500/charmm-gui/gromacs/crystal_myc_500.psf",
             "xtc": "MYC/MYC-500/charmm-gui/gromacs/run1/step6.0_protein_only.xtc"},
            {"psf": "MYC/MYC-1000/charmm-gui/gromacs/crystal_myc_1000.psf",
             "xtc": "MYC/MYC-1000/charmm-gui/gromacs/run1/step6.0_protein_only.xtc"},
            {"psf": "MYC/MYC-1500/charmm-gui/gromacs/crystal_myc_1500.psf",
             "xtc": "MYC/MYC-1500/charmm-gui/gromacs/run1/step6.0_protein_only.xtc"},
        ],
        "crystal_psf":   "MYC/MYC-500/charmm-gui/gromacs/crystal_myc_500.psf",
        "crystal_pdb":   "MYC/MYC-500/charmm-gui/gromacs/crystal_myc_500.pdb",
        "color":         "#3498db",
        "mean_color":    "#1a5276",
        "label":         "MYC alone",
        "ca_selection":  "backbone and name CA",
        "rg_selection": "name CA",
    },
    "MYC:MAX isolated MYC": {
        "replicas": [
            {"psf": "MYC-MAX/MYC-MAX-500/charmm-gui/gromacs/crystal_myc_500.psf",
             "xtc": "MYC-MAX/MYC-MAX-500/charmm-gui/gromacs/run1/step6.0_myc_only.xtc"},
            {"psf": "MYC-MAX/MYC-MAX-1000/charmm-gui/gromacs/crystal_myc_1000.psf",
             "xtc": "MYC-MAX/MYC-MAX-1000/charmm-gui/gromacs/run1/step6.0_myc_only.xtc"},
            {"psf": "MYC-MAX/MYC-MAX-1500/charmm-gui/gromacs/crystal_myc_1500.psf",
             "xtc": "MYC-MAX/MYC-MAX-1500/charmm-gui/gromacs/run1/step6.0_myc_only.xtc"},
        ],
        "crystal_psf":   "MYC-MAX/MYC-MAX-500/charmm-gui/gromacs/crystal_myc_500.psf",
        "crystal_pdb":   "MYC-MAX/MYC-MAX-500/charmm-gui/gromacs/crystal_myc_500.pdb",
        "color":         "#e67e22",
        "mean_color":    "#784212",
...
def plot_rmsd(ax, results_dict):
    ...
    ax.set_title("Graph A: Backbone RMSD vs Crystal State", fontsize=13, fontweight="bold")
...
def plot_rg(ax, results_dict):
    ...
    ax.set_title("Graph C: Radius of Gyration (MYC chain only)", fontsize=13, fontweight="bold")
    ax.legend(fontsize=9, framealpha=0.85)
    ax.grid(alpha=0.25)
...
def write_stats(results_dict):
    ...
    if len(summary_rows) == 2:
        ...
        lines.append(f"\n{'='*70}")
        lines.append("  Delta (MYC:MAX - MYC alone)")
        lines.append(f"{'-'*70}")
