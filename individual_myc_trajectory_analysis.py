...
PSF_FILE = "MYC/MYC-500/charmm-gui/gromacs/crystal_myc_500.psf"

TRAJS = [
    "MYC/MYC-500/charmm-gui/gromacs/run1/step6.0_protein_only.xtc",
    "MYC/MYC-1000/charmm-gui/gromacs/run1/step6.0_protein_only.xtc",
    "MYC/MYC-1500/charmm-gui/gromacs/run1/step6.0_protein_only.xtc",
]
...
def analyze_rg(u):
    ...
    protein = u.select_atoms("backbone and name CA")
...
u = mda.Universe("MYC/MYC-500/charmm-gui/gromacs/crystal_myc_500.psf")
ca = u.select_atoms("name CA")

print("First residue:", ca.resids[0])
print("Last residue:", ca.resids[-1])
print("Total CA atoms (residues):", len(ca.resids))
...
ax.set_title(
    "Graph A: RMSD vs Crystal State - Three Replicas",
    fontsize=18,
    fontweight="bold"
)
...
ax.set_title(
    "Graph B: Per-Residue Flexibility - Three Replicas",
    fontsize=18,
    fontweight="bold"
)
...
ax.set_title(
    "Graph C: Radius of Gyration - Three Replicas",
    fontsize=18,
    fontweight="bold"
)
